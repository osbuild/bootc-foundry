...
#   CACHE_USERNAME, CACHE_PASSWORD - optional; ghcr.io login (if missing, skips cache pull/push)
#   TO_IMAGE, CACHE_URL, TO_TAG, ARCH, CONTAINERFILE, FROM_IMAGE, FROM_TAG - build params
