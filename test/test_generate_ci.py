            ...
            dict(
                ...
                expected={
                    ...
                    "script": [
                        ...
                        'test/build.sh "$CONTAINER_REF" ami x86_64 rhel-10.2',
                        "test/boot.sh",
                    ],
                },
            ),
            ...
            dict(
                ...
                expected={
                    ...
                    "script": [
                        ...
                        'test/build.sh "$CONTAINER_REF" qcow2 x86_64 rhel-10.2',
                        "test/boot.sh",
                    ],
                },
            ),
            ...
            dict(
                ...
                expected={
                    ...
                    "script": [
                        ...
                        'test/build.sh "$CONTAINER_REF" bootc-generic-iso x86_64 rhel-10.2 "$PAYLOAD_REF"',
                        "test/boot.sh",
                    ],
                },
            ),
